...
class RoutersFilter
{
    ...
    private array $routesRigestered;
    ...
    public function __construct()
    {
        ...
        $this->routesRigestered = Routes::get();
                
    }

    private function simpleRouter()
    {
        if(array_key_exists($this->uri,$this->routesRigestered[$this->method])){
            return $this->routesRigestered[$this->method][$this->uri];
        }
    ...
    {
        foreach ($this->routesRigestered[$this->method] as $index => $route) {
